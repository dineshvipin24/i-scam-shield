  ...
  public CallHistoryDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfFraudAlertLog = new EntityInsertionAdapter<FraudAlertLog>(__db) {
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        if (entity.getTriggerKeyword() == null) {
        ...
        if (entity.getTranscriptSnippet() == null) {
          statement.bindNull(7);
        } else {
    ...
    this.__insertionAdapterOfCallerReputation = new EntityInsertionAdapter<CallerReputation>(__db) {
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        if (entity.getUserFeedbackValue() == null) {
          statement.bindNull(7);
        } else {
      ...
      public List<FraudAlertLog> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            if (_cursor.isNull(_cursorIndexOfTriggerKeyword)) {
              _tmpTriggerKeyword = null;
            } else {
            ...
            if (_cursor.isNull(_cursorIndexOfTranscriptSnippet)) {
              _tmpTranscriptSnippet = null;
            } else {
      ...
      public CallerReputation call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            if (_cursor.isNull(_cursorIndexOfUserFeedbackValue)) {
              _tmpUserFeedbackValue = null;
            } else {
